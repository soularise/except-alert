...
ALTER TABLE actions         ADD COLUMN tenant_id UUID REFERENCES tenants(id);
ALTER TABLE action_templates ADD COLUMN tenant_id UUID REFERENCES tenants(id);
ALTER TABLE baselines       ADD COLUMN tenant_id UUID REFERENCES tenants(id);
...
CREATE INDEX idx_events_tenant    ON events          (tenant_id, received_at DESC);
CREATE INDEX idx_actions_tenant   ON actions         (tenant_id);
CREATE INDEX idx_baselines_tenant ON baselines       (tenant_id);
CREATE INDEX idx_templates_tenant ON action_templates(tenant_id);
